...
if n_fuel_plots > 0:
    ...
    plt.suptitle('All Fuel Volumes: Angular Velocity vs Groove Radius (Scatter)', fontsize=14, y=1.02)
    plt.tight_layout()
    plt.savefig('grid_all_fuel_volumes_vs_radius_scatter.png', dpi=150, bbox_inches='tight')
    plt.show()
    print("  Saved: grid_all_fuel_volumes_vs_radius_scatter.png")
...
if n_radius_plots > 0:
    ...
    plt.suptitle('All Groove Radii: Angular Velocity vs Fuel Volume (Scatter)', fontsize=14, y=1.02)
    plt.tight_layout()
    plt.savefig('grid_all_groove_radii_vs_fuel_scatter.png', dpi=150, bbox_inches='tight')
    plt.show()
    print("  Saved: grid_all_groove_radii_vs_fuel_scatter.png")
