...
class TJunctionTrainer:
    ...
    def generate_tjunction_points(self, n_points=5000):
        ...
        t_main = torch.rand(n_main, 1) * 1.5  # Extended time range
        ...
        t_branch = torch.rand(n_branch, 1) * 0.7  # Extended time range
        ...
        t_junction = torch.rand(n_junction, 1) * 0.7  # Extended time range
    ...
    def generate_boundary_points(self, n_points=1000):
        ...
        t_inlet = torch.rand(n_inlet, 1) * 0.7  # Extended time range
        ...
        t_outlet = torch.rand(n_outlet, 1) * 0.7  # Extended time range
        ...
        t_branch_out = torch.rand(n_branch_out, 1) * 0.7  # Extended time range
    ...
    def visualize_results(self, time_points=[0.0, 0.2, 0.4, 0.6]):
...
def main():
    ...
    # Visualize results at extended time points for natural propagation
    trainer.visualize_results(time_points=[0.0, 0.2, 0.4, 0.6])
